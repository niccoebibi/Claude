...
- **Il gioco degli sposi:** nel profilo di ogni invitato un quiz su di voi, con emoji e coriandoli a ogni risposta giusta. Chi lo finisce riceve un **trofeo** accanto al nome (anche nella chat LIVE); chi indovina tutto, il **trofeo brillante** e un posto nell'albo d'oro. I **primi 3** che indovinano tutto vincono un premio: nella Regia vedete chi sono.
