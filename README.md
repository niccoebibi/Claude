...
- **Il gioco degli sposi:** nel profilo di ogni invitato un quiz su di voi, con emoji e coriandoli a ogni risposta giusta, e alcuni effetti speciali in stile videogioco anni '90 (un drago sputafuoco, una pioggia di anelli d'oro, un ballerino, una bamboletta al mare, la campana della borsa, i fulmini, un brindisi) che scegliete voi domanda per domanda. Le risposte giuste restano segrete, così nessuno le passa agli altri. Chi lo finisce riceve un **trofeo** accanto al nome (anche nella chat LIVE); chi indovina tutto, il **trofeo brillante** e un posto nell'albo d'oro. I **primi 3** che indovinano tutto vincono un premio: nella Regia vedete chi sono.
